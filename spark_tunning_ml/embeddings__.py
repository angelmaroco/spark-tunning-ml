...
def index_files_milvus(filelst: list, collection_name: str):
    ...
    text_splitter = NLTKTextSplitter(chunk_size=10000, chunk_overlap=200)
...
def create_collection_schema(collection_name: str):
    ...
    schema = CollectionSchema(fields, description="Schema for different file types", enable_dynamic_field=True)
