...
@pytest.mark.parametrize(
    ...
    [
        (
            ...
            ["app-20231204142916-0004", "app-20231204142916-0005"],
        ),
    ],
)
def test_get_ids_from_applications_case1(applications, expected_ids, spark_ui_wrapper):
    ids = spark_ui_wrapper.get_ids_from_applications(applications, filter_completed=False)
...
def test_get_ids_from_applications_case2(applications, expected_ids, spark_ui_wrapper):
    ids = spark_ui_wrapper.get_ids_from_applications(applications, filter_completed=True)
    assert ids == expected_ids
